package com.example.travelapps2.database;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "db_sipelita";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("insert into " + TABLE_USER + " values ('rizal@gmail.com','rizal','Fahrizal');");
    }
