...
public class PesanKatalog extends AppCompatActivity {
    ...
    String HttpUrl="http://webfr.wsjti.com/transaksikatalog.php";
    Boolean CheckEditText;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.pesan_katalog);
        ...
        requestQueue =Volley.newRequestQueue(PesanKatalog.this);
        progressDialog= new ProgressDialog(PesanKatalog.this);
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (CheckEditText){
                    ...
                    Toast.makeText(PesanKatalog.this,"Penuhi form",Toast.LENGTH_LONG).show();
                }
            }
        });
    }
    ...
    public void UserRegistration() {
        ...
        StringRequest stringRequest =new StringRequest(Request.Method.POST, HttpUrl,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String ServerResponse) {
                        ...
                        Intent intent = new Intent(PesanKatalog.this, BayarPaket.class);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                        ...
                        Toast.makeText(PesanKatalog.this,volleyError.toString(),Toast.LENGTH_LONG).show();
                    }
                }){
            @Override
            protected Map<String, String> getParams() {
                Map<String,String> params = new HashMap<>();
                params.put("id_katalog", idkatalogHolder);
        ...
        RequestQueue requestQueue= Volley.newRequestQueue(PesanKatalog.this);
