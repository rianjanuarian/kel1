...
public class PesanPenginapan extends AppCompatActivity {
    ...
    String HttpUrl="http://webfr.wsjti.com/transaksipenginapan.php";
    Boolean CheckEditText;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.pesan_penginapan);
        ...
        requestQueue =Volley.newRequestQueue(PesanPenginapan.this);
        progressDialog= new ProgressDialog(PesanPenginapan.this);
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (CheckEditText){
                    ...
                    Toast.makeText(PesanPenginapan.this,"Penuhi form",Toast.LENGTH_LONG).show();
                }
            }
        });
    }
        ...
        StringRequest stringRequest =new StringRequest(Request.Method.POST, HttpUrl,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String ServerResponse) {
                        ...
                        Intent intent = new Intent(PesanPenginapan.this, BayarPaket.class);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                        ...
                        Toast.makeText(PesanPenginapan.this,volleyError.toString(),Toast.LENGTH_LONG).show();
                    }
                }){
            @Override
            protected Map<String, String> getParams() {
                ...
                params.put("id_hotel",idpelangganHolder);
                params.put("tgl_transaksi",tgltransaksiHolder);
                params.put("tgl_checkin",tglberangkatholder);
                params.put("penerima",penerimaHolder);
                params.put("id_pelanggan",AlamatHolder);
                params.put("nohp_penerima",nohppenerimaHolder);

                return params;
            }
        };
        RequestQueue requestQueue= Volley.newRequestQueue(PesanPenginapan.this);
    ...
    public void CheckEditTextIsEmptyOrNot() {
        ...
        if ( TextUtils.isEmpty(idpelangganHolder) || TextUtils.isEmpty(tgltransaksiHolder) || TextUtils.isEmpty(tglberangkatholder) || TextUtils.isEmpty(penerimaHolder) || TextUtils.isEmpty(AlamatHolder) || TextUtils.isEmpty(nohppenerimaHolder)){
            CheckEditText=false;
        }
        else {
            CheckEditText=true;
