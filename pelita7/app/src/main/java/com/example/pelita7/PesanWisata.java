...
public class PesanWisata extends AppCompatActivity {
    ...
    String HttpUrl="http://webfr.wsjti.com/transaksiwisata.php";
    Boolean CheckEditText;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.pesan_wisata);
        ...
        requestQueue =Volley.newRequestQueue(PesanWisata.this);
        progressDialog= new ProgressDialog(PesanWisata.this);
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (CheckEditText){
                    ...
                    Toast.makeText(PesanWisata.this,"Penuhi form",Toast.LENGTH_LONG).show();
                }
            }
        });
    }
    ...
    public void UserRegistration() {
        ...
        StringRequest stringRequest =new StringRequest(Request.Method.POST, HttpUrl,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String ServerResponse) {
                        ...
                        Intent intent = new Intent(PesanWisata.this, BayarPaket.class);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                        ...
                        Toast.makeText(PesanWisata.this,volleyError.toString(),Toast.LENGTH_LONG).show();
                    }
                }){
            @Override
            protected Map<String, String> getParams() {
                ...
                params.put("id_wisata",idpelangganHolder);
                params.put("tgl_transaksi",tgltransaksiHolder);
                params.put("tgl_pakai",tglberangkatholder);
        ...
        RequestQueue requestQueue= Volley.newRequestQueue(PesanWisata.this);
